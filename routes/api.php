...
Route::get('student-overview', [PaymentGatewayController::class, 'getStudentOverview']);
...
Route::post('student/responses/short-answer', [ExamResponseController::class, 'getResponsesByBatchAndStudent']);
