...
public function storeExamResponse(Request $request)
{
    try {
        ...
        // Initialize question marks map with default values
        $questionMarksMap = $examQuestions->mapWithKeys(function ($examQuestion) {
        ...
        foreach ($validated['responses'] as $response) {
            ...
            if (!isset($questionMarksMap[$questionId])) {
                continue; // Skip if the question ID does not exist in the exam
            }
            ...
            $question = $examQuestions->get($questionId);
            $correctAnswers = $question->question->correct_answers;
            $questionType = $question->question->question_type;
            ...
            if ($questionType === 'MCQ') {
                ...
                $questionMarksMap[$questionId]['status'] = 'pending'; // For non-MCQ types, mark as pending
            }
        }
